...
import { convertDocument } from "@/api/document";
...
export default function DocumentConverter() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addTask({ taskId: result.task_id, type: "document", source: file.name, detailPath: `/task/${result.task_id}` });
      toast.success("任务已提交！");
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">文档转笔记</h1>
